...
rhel_firefox(){
      ...
      wget -O firefox.tar.bz2 https://download-installer.cdn.mozilla.net/pub/firefox/nightly/latest-mozilla-central-l10n/firefox-${firefox_version}.${lang}.linux-x86_64.tar.bz2
      tar xvjf firefox.tar.bz2 &> /dev/null
      sudo rm firefox.tar.bz2
      ln -s /usr/local/firefox/firefox /usr/bin/firefox
      popd || exit
      mv firefox.desktop /usr/share/applications/
      mv nightly.png /usr/share/pixmaps/
      }
